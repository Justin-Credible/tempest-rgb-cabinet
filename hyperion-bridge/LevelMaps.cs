        ...
        { 2, new Dictionary<int, List<int>>()
            {
                ...
                { 4, new List<int>() { 31, 32, 33 } },
                { 5, new List<int>() { 29, 29, 30 } },
                { 6, new List<int>() { 25, 26, 27, 28 } },
                { 7, new List<int>() { 20, 31, 22, 23, 24 } },
                { 8, new List<int>() { 16, 17, 19, 19 } },
                ...
                { 15, new List<int>() { 46, 47, 49, 49, 50 } },
            }
        },
        ...
        { 3, new Dictionary<int, List<int>>()
            {
                ...
                { 5, new List<int>() { 29, 30 } },
                { 6, new List<int>() { 25, 26, 27, 28 } },
                { 7, new List<int>() { 20, 31, 22, 23, 24, 25 } },
